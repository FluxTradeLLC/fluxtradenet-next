...
const socialLinks = [
  {
    ...
    label: s("streaming.followYouTube"),
    icon: (
  ...
  },
  {
    ...
    label: s("streaming.followTwitch"),
    icon: (
  ...
  },
  {
    ...
    label: s("streaming.followInstagram"),
    icon: (
  ...
  },
  {
    ...
    label: s("streaming.followTikTok"),
    icon: (
  ...
  },
  {
    ...
    label: s("streaming.followFacebook"),
    icon: (
...
export function StreamingContent() {
  return (
    <ContentPageLayout
      ...
      description={s("streaming.description")}
      maxWidth="max-w-7xl"
    >
      <div className="mx-auto flex max-w-4xl justify-center">
        <div className="glass-card w-full overflow-hidden rounded-2xl p-2 sm:p-3">
          <TwitchEmbed channel="fluxtradellc" />
        </div>
      </div>

      <p className="mx-auto mt-8 max-w-3xl text-sm italic text-muted/80">
