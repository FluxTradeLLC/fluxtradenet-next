        ...
        <div className="grid gap-12 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-lg border border-border px-4 py-2 text-sm text-muted transition-colors hover:border-flux-green-icon/40 hover:text-flux-green-icon"
            >
