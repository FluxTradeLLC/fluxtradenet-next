        ...
        <div className="grid gap-12 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3">
              ...
              />
              <span className="text-lg font-bold italic">FluxTrade</span>
            </Link>
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted">
              Advanced trading software and subscription-based tools for traders
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-lg border border-border px-4 py-2 text-sm text-muted transition-colors hover:border-flux-green-icon/40 hover:text-flux-green-icon ml-26"
            >
            ...
            <div
              className="trustpilot-widget mt-6 max-w-sm"
              data-locale="en-US"
              ...
              data-theme="dark"
              data-token="3b1038c5-8231-4116-a967-4fabb018bc5c"
            >
              <a
              ...
              <ul className="mt-4 space-y-3">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm text-muted transition-colors hover:text-flux-green"
                    >
                      {link.label}
                    </Link>
                  </li>
